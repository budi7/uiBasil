          ...
          <div class="content">
            ...
            >
              ...
              <template #content>
                <div v-if="!onlyOption">
                  ...
                  >
                    <div class="check d-flex pl-3">
                      <img v-if="selected" src="~/assets/img/radio-off.svg" width="13">
                      <img v-else src="~/assets/img/radio-on.svg" width="13">
                    </div>
                    <div class="col-auto py-3">
                      <p class="mb-0 minititle">
                        {{ labelGeneral.all[lang] }}
                      </p>
                    </div>
                    <div class="col-12">
                      <hr class="my-0">
                ...
                <div v-for="(dt,i) in options" :key="'c-' + i">
                  <div
                    class="row mx-0 select-group"
                    @click="() => {
                      selected = dt
                  ...
                  >
                    <div class="check d-flex pl-3">
                      <img v-if="selected === dt" src="~/assets/img/radio-on.svg" width="13">
                      <img v-else src="~/assets/img/radio-off.svg" width="13">
                    </div>
                    <div class="col-auto py-3">
                      <p class="mb-0 minititle">
